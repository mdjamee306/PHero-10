            ...
            <section className="text-white body-font overflow-hidden">
                <div className="container bg-slate-200 px-5 mx-auto">
                    ...
                    <div data-aos="fade-up">
                        ...
                        <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-gray-500">We offer competitive pricing to ensure that you receive exceptional value for your investment. Plus, as your needs evolve, our plans can easily scale with you.</p>
                        <div className="flex mx-auto border-2 border-yellow-600 rounded overflow-hidden mt-6">
                            <button className="py-1 px-4 bg-yellow-700 text-white focus:outline-none">Monthly</button>
                            <button className="py-1 px-4 focus:outline-none">Annually</button>
                        </div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 -m-4 w-3/4 mx-auto gap-6">
                        ...
                        <div data-aos="fade-up" className="">
                            <div className="h-full p-6 rounded-lg border-2 border-yellow-600 flex flex-col relative overflow-hidden">
                                <span className="bg-yellow-700 text-white px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">POPULAR</span>
                                ...
                                <button className="flex items-center mt-auto text-white bg-yellow-700 border-0 py-2 px-4 w-full focus:outline-none hover:bg-indigo-600 rounded">Button
                                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-auto" viewBox="0 0 24 24">
                                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                                    </svg>
                                </button>
